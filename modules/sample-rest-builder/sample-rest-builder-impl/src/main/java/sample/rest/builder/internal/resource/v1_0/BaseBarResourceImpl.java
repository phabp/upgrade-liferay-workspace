...
public abstract class BaseBarResourceImpl implements BarResource {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Bar")}
	)
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/bars/{barId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Bar deleteBar(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("barId")
			Long barId)
		throws Exception {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseBarResourceImpl.class);
